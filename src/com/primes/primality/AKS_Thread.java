 ...
 *
 */
public class AKS_Thread extends Thread {
	 ...
	 * @param n
	 */
	public AKS_Thread(BigInteger n) {
		this.n = n;
	}
	...
	public boolean isPrime() {
		// TODO: Do this in linear time
		// http://www.ams.org/journals/mcom/1998-67-223/S0025-5718-98-00952-1/S0025-5718-98-00952-1.pdf
		...
		for (int i = 1; i <= limit; i++) {
			...
			if (!outcome.equals(p)) {
				...
				// if (verbose) System.out.println("(x+i)^" + n + " = x^" + n +
				// " + " + i + " (mod x^" + r + " - 1, " + n + ") failed");
	...
	/***
	 * Calculate the totient of a BigInteger r Based on this algorithm:
	 * 
	 * http://community.topcoder.com/tc?module=Static&d1=tutorials&d2=primeNumbers
	 * 
	 * @param r
	 *            BigInteger to calculate the totient of
	...
	/***
	 * Calculate the multiplicative order of n modulo r This is defined as the
	 * smallest positive integer k for which n^k = 1 (mod r).
	 * 
	 * @param r
	 *            modulus for mutliplicative order
